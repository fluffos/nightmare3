...
protected void input_password(string str) {
    if(strlen(str) < 5) {
...
protected void confirm_password(string str) {
    if(str != __Password) {
...
protected void input_cap_name(string str) {
...
protected void input_email(string str) {
    object ob;
    string tmp;
