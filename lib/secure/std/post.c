...
varargs  private  private void postal_error(string str, string ind, mixed args) {
...
varargs  private  private void postal_success(string str,string ind,mixed args) {
...
varargs  private  void indices(int x, string str) {
    int i, maxi;
...
varargs  private  void aliases(string str) {
    __CurrentMenu = "alias";
    if(str && str != "") {
        alias_cmd(str);
        return;
...
varargs  private  void options(string str) {
    string tmp;
    int i, maxi;
